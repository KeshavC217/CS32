...
//	t.insert("GAT", 6);
//	t.insert("GAC", 7);
//	result = t.find("GAP", true);
//	for (int c = 0; c < result.size(); c++)
//		cout << result[c] << endl;*/
//	string filename = "C:/Users/kesha/source/repos/Project4_Updated/Project4_Updated/data/test.txt";
...
const string PROVIDED_DIR = "C:/Users/kesha/source/repos/Project4_Updated/Project4_Updated/data";
